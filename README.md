...
[![Woolworths Price Tracker](https://img.shields.io/badge/Woolworths%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.co.kr/products/insights/price-tracker/woolworths)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.co.kr/products/insights/price-tracker/woolworths)

실시간 Woolworths 가격 추적 - 호주 최대 슈퍼마켓 체인. 시작하는 방법은 두 가지입니다: **완전 관리형** 인텔리전스 플랫폼 또는 Bright Data의 AI Scraper Builder로 구축한 **커스텀 scraper**.

---

## 옵션 1: Bright Insights - AI 기반 가격 추적 (권장)

**[Bright Insights](https://brightdata.co.kr/products/insights/price-tracker/woolworths)**는 Bright Data의 완전 관리형 리테일 인텔리전스 플랫폼입니다. scraper를 구축할 필요도, 인프라를 유지할 필요도 없습니다. 구조화되고 분석 준비가 완료된 가격 데이터를 대시보드, 데이터 피드 또는 BI 도구로 바로 전달받을 수 있습니다.
...
**주요 사용 사례:**
- ✅ Woolworths 전 카테고리의 **식료품 가격 인플레이션 추적**
- ✅ **프로모션** 및 주간 할인 자동 모니터링
...
> **월 $250부터 - [맞춤 견적 받기 →](https://brightdata.co.kr/products/insights/price-tracker/woolworths)**

---

## 옵션 2: 직접 Woolworths Scraper 구축하기

사전 구축된 Woolworths scraper API가 없나요? 문제없습니다. Bright Data의 **AI Scraper Builder**가 몇 번의 클릭만으로 커스텀 Woolworths scraper를 생성합니다 — 코딩은 필요 없습니다.

### 몇 분 만에 Woolworths scraper 구축하기

**[Woolworths AI Scraper Builder 열기 →](https://brightdata.co.kr/products/web-scraper/woolworths)**
...
- Woolworths용 **Web Scraper ID** (위 build 단계에서 획득)
...
1. **이 repository 복제**
   ...
   ```bash
   git clone https://github.com/bright-kr/woolworths-price-tracker.git
...
3. **자격 증명 구성**
   ...
   > **Your Web Scraper ID**
   > [AI Scraper Builder dashboard](https://brightdata.co.kr/products/web-scraper/woolworths)에서 Web Scraper ID를 복사해
...
Woolworths scraper를 구축하고 `.env`에 Web Scraper ID를 구성하면, Python 인터페이스는 동일한 방식으로 동작합니다:

### 1. URL로 특정 상품 추적

구조화된 가격 데이터를 가져오기 위해 Woolworths 상품 URL 목록을 전달합니다:
...
Woolworths 카테고리 페이지의 모든 상품을 수집합니다:
...
- 🌟 [Woolworths Price Tracker - Bright Insights (Managed)](https://brightdata.co.kr/products/insights/price-tracker/woolworths)
- 🏗️ [Woolworths Scraper 구축하기](https://brightdata.co.kr/products/web-scraper/woolworths)
